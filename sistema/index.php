				...
				<div class="card">
					...
					<div class="card-body">
						<form action="empresa.php" method="post" id="frmEmpresa" class="p-3">
							<div class="form-group">
								<label>Ruc:</label>
								<input type="number" name="txtdocumento" value="<?php echo $documento; ?>" id="txtdocumento" placeholder="documento de la Empresa" required class="form-control">
							</div>
							<div class="form-group">
								<label>Nombre:</label>
